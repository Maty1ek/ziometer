...
export default function Home() {
  return (
    <div className="flex flex-col justify-center pt-[18px] items-center overflow-hidden relative">
      <div className="absolute top-[-18px] min-w-[760px] z-0">
        ...
        <div className="main_input_con py-[22px] px-[20px] mt-[40px] w-full bg-[#fafafa3a] rounded-[15px]">
          ...
          <div className="flex flex-col justify-center">
            ...
            <div className="flex my-[10px]">
              <div className="w-[50%]">
                <input type="text" className="bg-white w-[120px] h-[23px] rounded-[5px]"/>
              </div>
              <div className="w-[50%]">
                <input type="text" className="bg-white w-[120px] h-[23px] rounded-[5px]"/>
              </div>
            ...
            <button className="bg-[#fff] rounded-[6px] h-[30px] w-[135px] font-bold text-[15px] mt-[20px]">Add country +</button>
          </div>
        </div>

        <button className="submit_button mt-[40px] color-[#0f0f0f] text-[26px] font-bold w-full rounded-[14px] bg-white h-[50px]">SUBMIT</button>
      </div>
    </div>
  );
}
