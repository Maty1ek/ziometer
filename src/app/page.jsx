...
export default function Home() {
  return (
      <div className="flex flex-col justify-center pt-[18px] items-center h-[100dvh] relative overflow-hidden">
        <div className="absolute flex justify-center top-[-18px] h-full min-h-[750px]  w-full ">
